...
RSpec.describe User, type: :model do
  before(:each) do
    @user_role = Role.create(name: "test")
  end
  ...
  it "requires a unique email" do
    User.create(first_name: "Jerry", last_name: "Doe", email: "jerry_doe@test.com", password: "test123", role_id: @user_role.id)
    u = User.create(first_name: "Jerry Jim", last_name: "Doe", email: "jerry_doe@test.com", password: "test123", role_id: @user_role.id)
    expect(u).to_not be_valid
  end
